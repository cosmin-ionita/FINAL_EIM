...
public class ClientFragment extends Fragment {
    ...
    private TextView commandTextEdit;
    ...
    private class ButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            clientAsyncTask.execute(serverAddressEditText.getText().toString(), serverPortEditText.getText().toString(), commandTextEdit.getText().toString());
        }
    }
    ...
    public void onActivityCreated(Bundle state) {
        ...
        commandTextEdit = (EditText)getActivity().findViewById(R.id.command_edit_text);
    }
